...
const TimSmith = () => {
  return (
        <div className='container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 lg:m-20 lg:p-8 mt-20'>
            <div className='mb-4'>
                <img src="/images/image 9.png" alt="icons" title='img' className='W-64 h-auto' />
            </div>
            <div className='ms-8  space-y-4 md:mt-10'>
                ...
                <img src="/images/Frame 14.svg" alt="icon" width={600} height={400} className='w-full md:w-[500px] lg:w-[600px] h-auto'
                 />
            </div>
        </div>
  )
